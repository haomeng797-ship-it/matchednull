...
Look again at the right panel of the positive-control figure. The test detects
the planted types at 1.5 and at 2 standard deviations of separation, and then,
at 3 standard deviations, where the types are further apart than anywhere else
in the figure, it goes quiet. Read as a power curve that is backwards. It cost
